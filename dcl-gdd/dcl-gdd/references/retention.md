...
**So nobody promises 40%** *(traced 2026-08-28; full provenance in
...
is >10%, the program-level target >20%. Both bars apply only once at least **ten eligible new
users** have a completed window; below that it is *insufficient evidence*, not a fail. Two cautions
before quoting anything at an owner. It is a
