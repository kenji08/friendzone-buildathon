 ...
 * 球が枯れると誰も勝てなくなる。上限人数が勝利数-1個ずつ抱えても
 * なお1個余る数にしておく（6人 x 5個 + 1）。
 */
export const ORB_COUNT = 32
...
/** 他のプレイヤーとぶつかったと判定する距離（メートル） */
export const BUMP_RADIUS = 1.6

/** 同じ相手と続けてぶつかったことにしない間隔（秒） */
export const BUMP_COOLDOWN = 2

/**
 * ぶつかって落とした球が飛ぶ距離（メートル）。
 * 足元に落とすと、取得が距離判定なので落とした本人がすぐ拾い直してしまう。
 */
export const BUMP_SCATTER = 4
...
export const MIN_ORB_SEPARATION = 2.8
